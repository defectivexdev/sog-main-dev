...
const roleLabel: Record<string, string> = { leader: "หัวหน้า", admin: "ผู้จัดการ", member: "สมาชิก" };
const roleColor: Record<string, string> = { leader: "#c9a227", admin: "#a78bfa", member: "#94a3b8" };
